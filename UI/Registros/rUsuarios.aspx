                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-inline-flex">
                                ...
                                <div class="i-checks" runat="server">
                                    <input id="radioCustom1" type="radio" value="a" name="a" class="form-control-custom radio-custom">
                                    <label for="radioCustom1">Normal</label>
                                </div>
                                <div class="i-checks" runat="server">
                                    <input id="radioCustom2" type="radio" value="u" name="a" class="form-control-custom radio-custom">
